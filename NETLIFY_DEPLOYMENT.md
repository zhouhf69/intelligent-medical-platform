...
7. 等待1-2分钟
8. 在左侧菜单点击 "Project Settings"
9. 点击 "Database"
10. 找到 "Connection string" 部分
11. 选择 "URI" 标签
12. 复制连接字符串，格式如下：
    ```
    postgresql://postgres:[YOUR-PASSWORD]@db.[PROJECT-REF].supabase.co:5432/postgres
    ```
13. 将 `[YOUR-PASSWORD]` 替换为你设置的密码
14. 将完整的连接字符串粘贴到Netlify的 `DATABASE_URL` 变量中
...
- [GITHUB_NETLIFY_DEPLOYMENT.md](./GITHUB_NETLIFY_DEPLOYMENT.md) - GitHub和Netlify部署
- [QUICK_DEPLOYMENT.md](./QUICK_DEPLOYMENT.md) - 快速部署
